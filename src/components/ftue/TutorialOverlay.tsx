...
const TUTORIAL_STEPS = [
    {
        targetId: 'ftue-hero',
        title: 'Your Money HQ 🎛️',
        message: "This is the big picture — your total net worth, monthly moves, and ROI. One glance tells you if your money's grooving or snoozing.",
        position: 'bottom',
    },
    {
        ...
        title: 'The Asset Mix 🎸',
        message: "Your wealth split across asset classes — stocks, crypto, real estate, the works. Tap any card to dive deep.",
        position: 'left',
    },
    {
        targetId: 'ftue-currency-pill',
        title: 'Currency Flip 🌍',
        message: "Tap to see everything in a different currency. BRL, GBP, USD — switch it up depending on your vibe.",
        position: 'bottom',
    },
    {
        targetId: 'ftue-charts',
        title: 'The Visual Groove 📊',
        message: "Charts that show your money's journey — growth curves, allocation donuts, performance trends. Customize the layout to your taste.",
        position: 'top',
    },
    {
        targetId: 'ftue-tables',
        title: 'The Details 🔍',
        message: "Every single holding, position by position. This is where you get granular.",
        position: 'top',
    },
    {
        targetId: 'ftue-nav',
        mobileTargetId: 'ftue-nav-mobile',
        title: 'Navigate the Funk 🎹',
        message: "Jump between asset pages, budgets, planning tools, and your general ledger. Everything's one tap away.",
        position: 'bottom',
    },
    {
        ...
        message: "Tweak your settings, manage your account, and make Finance Funk truly yours.",
        position: 'bottom-end',
    },
];
