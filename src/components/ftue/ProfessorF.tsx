...
const POSES = {
    ...
    avatar: '/ftue/funk-master-avatar.png',
};

export default function ProfessorF({ message, pose = 'welcome', size = 'md', animate = true }: any) {
    const sizeMap = {
    ...
    const s = (sizeMap as any)[size] || sizeMap.md;
    const imgSrc = (POSES as any)[pose] || POSES.welcome;
