...
export default function FTUEChecklist({ mode = 'sidebar' }: any) {
    ...
    const renderSimpleRow = (item: any) => (
        <div 
            key={item.id} 
        ...
        >
            ...
            <span className={`font-space text-xs leading-tight ${item.isDone ? 'line-through text-[#F5F5DC]/50' : 'text-[#F5F5DC]/90'}`}>
                {item.label}
            </span>
    ...
    const sidebarContent = (
        <div className="flex flex-col h-full bg-[#0D0814]/95 backdrop-blur-[24px] border-l border-[#D4AF37]/15">
            <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-6">
                ...
                <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-space text-xs text-[#F5F5DC]/50 leading-none">
                        ...
                        {isCompact && (
                        <div>
                            <h3 className="font-bebas text-sm tracking-[0.04em] text-[#D4AF37] leading-none">{completedCount}/{total}</h3>
                        </div>
                        )}
                    </div>
                    {mode === 'sidebar' && (
                ...
                <div className="mb-6">
                    {!isCompact && <h4 className="font-bebas text-xs tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-2">Connect your data</h4>}
                    ...
                    <div className="flex items-center gap-[10px] px-3 py-2.5 bg-[#1A0F2E]/50 border border-[#D4AF37]/10 rounded-[10px] mb-1.5 opacity-60 cursor-default">
                        ...
                        <span className="font-space text-xs text-[#F5F5DC]/50 flex-1">Connect bank account</span>
                        <span className="font-space text-2xs uppercase tracking-[0.06em] bg-[#CC5500]/15 text-[#CC5500] px-2 py-0.5 rounded-[4px] font-bold">Coming Soon</span>
                    </div>
                    ...
                    >
                        ...
                        <span className="font-space text-xs text-[#F5F5DC]/80 flex-1">Import transactions</span>
                    ...
                    >
                        ...
                        <span className="font-space text-xs text-[#F5F5DC]/80 flex-1">Import budget data</span>
                        <ChevronRight size={14} className="text-[#F5F5DC]/30" />
                    </div>
                    )}
                </div>
                ...
                <div className="mb-6">
                    {!isCompact && <h4 className="font-bebas text-xs tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-1">Set up your portfolio</h4>}
                ...
                {/* Section: Track & grow */}
                <div className="mb-6">
                    {!isCompact && <h4 className="font-bebas text-xs tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-1">Track & grow</h4>}
                    <div className="flex flex-col">
            ...
            <div className="px-4 py-6 border-t border-[#D4AF37]/10 bg-[#0B061A]/50 shrink-0">
                {ftueState.usingDemoData && (
                    <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-center">
                        <p className="text-2xs text-red-200/70 font-space mb-1">Currently browsing Demo Data.</p>
                        <button 
                            onClick={async () => {
                                await updateFtueProgress({ usingDemoData: false });
                                refreshAllData?.();
                            }} 
                            className="bg-red-500/20 hover:bg-red-500/30 text-red-400 font-bold font-space text-xs px-3 py-1.5 rounded transition-colors w-full"
                        >
                            Switch to Real Data
                        </button>
                    </div>
                ...
                <button 
                    ...
                    className="w-full font-space text-2xs text-[#F5F5DC]/25 hover:text-[#F5F5DC]/60 transition-colors py-1"
                >
                    I'll set up later
                </button>
            </div>
                ...
                <div className="flex items-center gap-2 flex-1">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between mb-1 pr-2">
                            <h3 className="font-bebas text-sm tracking-[0.04em] text-[#D4AF37] leading-none">Setup Guide</h3>
                            <span className="font-space text-2xs text-[#F5F5DC]/50">{progressPerc}%</span>
                        </div>
                ...
                {isMobileOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed bottom-0 left-0 right-0 h-[85vh] bg-[#0D0814] rounded-t-[20px] border-t border-[#D4AF37]/30 z-[500] flex flex-col shadow-[0_-10px_40px_rgba(0,0,0,0.8)]"
                        >
                            ...
                            <div className="flex-1 overflow-auto">
                                ...
                                <div className="p-0">
                                    <div className="px-5 py-6">
                                        {/* Section: Connect your data */}
                                        <div className="mb-6">
                                            <h4 className="font-bebas text-sm tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-3">Connect your data</h4>
                                            ...
                                            <div className="flex items-center gap-[12px] px-4 py-3 bg-[#1A0F2E]/50 border border-[#D4AF37]/10 rounded-[12px] mb-2 opacity-60">
                                                ...
                                                <span className="font-space text-sm text-[#F5F5DC]/50 flex-1">Connect bank account</span>
                                                <span className="font-space text-2xs uppercase tracking-[0.07em] bg-[#CC5500]/15 text-[#CC5500] px-2 py-0.5 rounded-[4px] font-bold">Coming Soon</span>
                                            </div>
                                            ...
                                            >
                                                ...
                                                <span className="font-space text-sm text-[#F5F5DC]/80 flex-1">Import transactions</span>
                                            ...
                                            >
                                                ...
                                                <span className="font-space text-sm text-[#F5F5DC]/80 flex-1">Import budget data</span>
                                                <ChevronRight size={16} className="text-[#F5F5DC]/30" />
                                            </div>
                                            )}
                                        </div>
                                        ...
                                        {showPortfolioSection && (
                                        <div className="mb-6">
                                            <h4 className="font-bebas text-sm tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-2">Set up your portfolio</h4>
                                            <div className="flex flex-col gap-1">
                                                {portfolioList.map(item => (
                                                    <div key={item.id} className="flex items-center gap-3 px-1 py-2.5">
                                                        ...
                                                        <span className={`font-space text-sm ${item.isDone ? 'line-through text-[#F5F5DC]/50' : 'text-[#F5F5DC]/90'}`}>{item.label}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                        ...
                                        {/* Section: Track & grow */}
                                        <div className="mb-8">
                                            <h4 className="font-bebas text-sm tracking-[0.06em] text-[#F5F5DC]/40 uppercase mb-2">Track & grow</h4>
                                            <div className="flex flex-col gap-1">
                                    ...
                                    <div className="px-5 py-6 bg-[#0B061A]/50 border-t border-[#D4AF37]/10">
                                        {ftueState.usingDemoData && (
                                            <div className="mb-5 p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-center">
                                                <p className="text-xs text-red-200/70 font-space mb-2">Currently browsing Demo Data.</p>
                                                <button 
                                                    onClick={async () => {
                                                        await updateFtueProgress({ usingDemoData: false });
                                                        refreshAllData?.();
                                                    }} 
                                                    className="bg-red-500/20 text-red-400 font-bold font-space text-sm px-4 py-2.5 rounded-lg w-full"
                                                >
                                                    Switch to Real Data
                                                </button>
                                            </div>
                                        ...
                                        <button 
                                            ...
                                            className="w-full font-space text-xs text-[#F5F5DC]/30 py-2 border border-[#F5F5DC]/10 rounded-lg"
                                        >
                                            Dismiss Checklist
                                        </button>
                                    </div>
