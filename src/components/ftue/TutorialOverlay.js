...
const TUTORIAL_STEPS = [
    {
        ...
        message: "Welcome to the dashboard \u2013 your strategic financial overview. Monitor your total net worth at a single glance, alongside Month-over-Month performance and ROI. Consider this your starting point.",
        position: 'bottom',
    },
    {
        ...
        message: "Your wealth is neatly categorized into distinct asset classes, each on its own card. Equities, fixed income, real estate, crypto, pensions, and debt. One tap takes you deep into the category\u2019s specifics.",
        position: 'left',
    },
    {
        targetId: 'ftue-currency-pill',
        title: 'Currency Switcher',
        message: "Instantly view your entire portfolio in different base currencies. BRL, GBP, USD \u2013 whatever suits your current context.",
        position: 'bottom',
    },
    {
        targetId: 'ftue-charts',
        title: 'Advanced Visual Analytics',
        message: "Track your portfolio\u2019s journey over time with dynamic growth curves, asset allocation donuts, and detailed performance charts. Tailor the layout to focus on your most critical metrics.",
        position: 'top',
    },
    {
        targetId: 'ftue-tables',
        title: 'Comprehensive Position Details',
        message: "This is where you get granular. Review every single holding and position, impeccably organized by asset class.",
        position: 'top',
    },
    {
        targetId: 'ftue-nav',
        ...
        message: "A unified menu to effortlessly jump to dedicated asset pages, powerful planning tools, growth forecasts, or your general ledger.",
        position: 'bottom',
    },
    {
        ...
        message: "Manage your personal profile, account preferences, and application settings directly from here.",
        position: 'bottom-end',
    },
];
