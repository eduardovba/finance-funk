...
const TUTORIAL_STEPS = [
    {
        targetId: 'ftue-hero',
        title: 'Total Control',
        message: "Your overarching net worth, monthly flow, and overall ROI. It all starts right here.",
        position: 'bottom',
    },
    {
        ...
        message: "Distinct cards for each asset class: equities, fixed income, property, crypto, pensions, and debt. Deep dive into any category with a tap.",
        position: 'left',
    },
    {
        targetId: 'ftue-currency-pill',
        title: 'Currency Shift',
        message: "Effortlessly switch views between your base currencies (BRL, GBP, USD).",
        position: 'bottom',
    },
    {
        targetId: 'ftue-charts',
        title: 'Portfolio Clarity',
        message: "Dynamic growth curves, allocation donuts, performance charts \u2013 configured for your essential metrics.",
        position: 'top',
    },
    {
        targetId: 'ftue-tables',
        title: 'Detail Central',
        message: "Grouped by class, this card provides granular visibility into every single position you hold.",
        position: 'top',
    },
    {
        targetId: 'ftue-nav',
        ...
        message: "Smoothly access specific asset pages, strategy tools, forecasts, or the unified ledger.",
        position: 'bottom',
    },
    {
        ...
        message: "Manage your profile, settings, and account preferences seamlessly.",
        position: 'bottom-end',
    },
];
