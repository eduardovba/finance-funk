...
export default function AirbnbTransactionForm({ onAdd, onCancel }: { onAdd: (entry: any) => void; onCancel: () => void; }) {
    ...
    const currencySymbol = (SUPPORTED_CURRENCIES as any)[formData.currency]?.symbol || 'R$';
