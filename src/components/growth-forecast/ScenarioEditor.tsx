                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        ...
                        <div className="bg-[#121418]/50 backdrop-blur-lg border border-white/[0.06] rounded-xl p-4 hover:border-[#D4AF37]/20 transition-colors">
                            <div className="flex justify-between items-center mb-3">
                                <span className="font-mono text-[10px] text-white/40 uppercase tracking-widest flex items-center gap-1.5"><Calendar size={10} /> Start Month</span>
                            </div>
                            <MonthCombobox value={startMonth} onChange={(v: string) => { setLastInteraction('inputs'); setStartMonth(v); }} />
                            <div className="mt-2 font-mono text-[10px] text-white/30">Starting: {formatK(startingValueBrl, 'BRL')}</div>
                        </div>
                        ...
                        <div className="bg-[#121418]/50 backdrop-blur-lg border border-white/[0.06] rounded-xl p-4 hover:border-[#D4AF37]/20 transition-colors">
                            ...
                            <div className="mt-2 font-mono text-[10px] text-white/30">Required: {formatK(requiredContributionHint, 'BRL')}/mo</div>
                        </div>
                        ...
                        <div className="bg-[#121418]/50 backdrop-blur-lg border border-white/[0.06] rounded-xl p-4 hover:border-[#D4AF37]/20 transition-colors">
                            ...
                            <div className="mt-2 font-mono text-[10px] text-white/30">Monthly: {(annualInterestRate / 12).toFixed(2)}%</div>
                        </div>
                        ...
                        <div className="bg-[#121418]/50 backdrop-blur-lg border border-white/[0.06] rounded-xl p-4 hover:border-[#D4AF37]/20 transition-colors">
                            ...
                            <div className="mt-2 font-mono text-[10px] text-white/30">Drag or click to set target</div>
                        </div>
                    </div>

                    <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-white/5">
                        <button onClick={() => handleSave(null)} className="flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-xs font-mono text-white/60 hover:text-white hover:border-white/20 transition-all">
                            <Save size={12} /> Save Draft
                        </button>
                        <button onClick={() => handleSave('lock')} className="flex items-center gap-1.5 bg-gradient-to-r from-[#D4AF37]/20 to-[#CC5500]/20 border border-[#D4AF37]/30 rounded-lg px-5 py-2 text-xs font-mono text-[#D4AF37] font-bold hover:border-[#D4AF37]/50 transition-all hover:shadow-[0_0_20px_rgba(212,175,55,0.15)]">
