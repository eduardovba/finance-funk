...
interface EquityBrokerSectionProps {
    brokerName: string;
    items: any[];
...
export default function EquityBrokerSection({
    brokerName, items: rawItems, brokerDict, lockedPnL, marketData, activeHoldings, rates,
    ...
    const calculatedRows = items.map((h: any) => {
        let rawPrice = 0;
    ...
    const rows = calculatedRows.sort((a: any, b: any) => {
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); handleNewBuyClick(brokerName); }}
