            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 relative z-10 w-full">
                    <div className="flex flex-col min-w-0 pr-2">
                        <h3 className="text-[#F5F5DC]/60 text-2xs xl:text-xs tracking-[2px] uppercase font-space mb-0 truncate" title={title}>{title}</h3>
        ...
        >
            ...
            <div className="mb-4 relative z-10">
                <div className="flex items-center justify-between gap-2">
                    <h3 className="text-[#F5F5DC]/60 text-xs xl:text-xs mb-2 tracking-[2px] uppercase font-space truncate" title={title}>{title}</h3>
