        ...
        <PullToRefresh onRefresh={onRefresh}>
            <div className="max-w-[1800px] mx-auto w-full pt-4 lg:pt-8">
                ...
                <div className="lg:flex lg:gap-8 lg:items-start">
                    ...
                    <div id="ftue-crypto-ledger" className="mt-12 mb-10 rounded-2xl bg-[#121418]/60 backdrop-blur-xl border border-white/[0.06] shadow-[0_8px_32px_rgba(0,0,0,0.4)] overflow-hidden">
                        <button
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            {!isCash && (
                                                <div className="bg-white/[0.02] border border-white/5 rounded-xl p-3">
                                                    <span className="block text-xs text-white/40 uppercase tracking-widest mb-1.5">Holdings</span>
                                            ...
                                            {!isCash && (
                                                <div className="bg-white/[0.02] border border-white/5 rounded-xl p-3">
                                                    <span className="block text-xs text-white/40 uppercase tracking-widest mb-1.5">Net Investment</span>
