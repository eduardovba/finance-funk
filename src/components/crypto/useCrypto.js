...
export default function useCrypto({ transactions = [], marketData, rates, onRefresh }) {
    ...
    const handleEditChange = (field, value) => { setEditingTr(prev => ({ ...prev, [field]: value })); };
    ...
    const handleSellConfirm = async () => {
        ...
        const tr = {
            ...
            pnl: parseFloat(sellData.pnl) || 0, type: 'Sell', platform: sellData.broker
        };
        try {
        ...
        } catch (e) { alert('Sell transaction failed: ' + e.message); console.error(e); }
    };
    ...
    const handleBuyConfirm = async () => {
        ...
        } catch (e) { alert('Add transaction failed: ' + e.message); console.error(e); }
    };
