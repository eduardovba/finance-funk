 ...
 */
export default function ProviderPicker({ providers, onSelect, onBack }) {
    const [selectedProvider, setSelectedProvider] = useState(null);

    const brProviders = providers.filter(p => p.country === 'BR');
    const ukProviders = providers.filter(p => p.country === 'UK');
...
function ProviderGroup({ title, providers, onSelect }) {
