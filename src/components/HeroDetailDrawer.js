 ...
 */
export default function HeroDetailDrawer({ categoryId, effectiveCurrency, totalCurrentValue }) {
    const {
    ...
    const fmt = (val) => formatCurrency(val, effectiveCurrency, { minimumFractionDigits: 0, maximumFractionDigits: 0 });
