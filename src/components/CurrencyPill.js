    ...
    return (
        <div ref={dropdownRef} className="relative">
            ...
            >
                ...
                <span className="text-[8px] text-parchment/40 ml-0.5">▼</span>
            </button>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between pb-3 border-b border-white/5">
                            <div className="flex flex-col gap-1">
                                <span className="text-[9px] font-space text-parchment/40 uppercase tracking-widest pl-2">Primary</span>
                                <CurrencyDropdown
                            ...
                            <div className="flex flex-col items-end gap-1">
                                <span className="text-[9px] font-space text-parchment/40 uppercase tracking-widest pr-2">Secondary</span>
                                <CurrencyDropdown
                        ...
                        <div className="space-y-3 px-1">
                            <div>
                                <div className="text-[9px] font-space text-parchment/40 uppercase tracking-widest mb-1.5">Exchange Rate</div>
                                <div className="flex items-center justify-between px-2 py-1.5 bg-white/5 rounded-lg border border-white/5">
                                    <div className="text-[10px] font-medium text-parchment">
                                        {rateFlipped ? (
                                    ...
                                    <button
                                        ...
                                        className="text-[10px] text-[#D4AF37]/60 hover:text-[#D4AF37] transition-colors bg-transparent border-none cursor-pointer font-bold"
                                    >
                                        Flip
                                    </button>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <div className="text-[9px] font-space text-parchment/40 uppercase tracking-widest mb-1">Source</div>
                                    <div className="text-[10px] text-parchment font-medium flex items-center gap-1.5">
                                        <span className="grayscale opacity-50 text-xs">📈</span>
                                        Google
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="text-[9px] font-space text-parchment/40 uppercase tracking-widest mb-1">Updated</div>
                                    <div className="text-[10px] text-parchment font-medium">{formattedTime}</div>
                                </div>
                            </div>
                        </div>
                    </div>
