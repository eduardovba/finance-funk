...
export default function useRealEstate({ data, rates, onRefresh, marketData = {} }) {
    ...
    return {
        ...
        handleDeleteAirbnbMonth,
        confirmDelete,
        handleSavePropertyValues,
        handleAddMortgagePayment,
        handleSetupMortgage,
        handleAddRentalEntry,
        handleFundBuyClick,
        handleNewFundBuyClick,
        updateFundBuyCalc,
        handleFundBuyConfirm,
        handleFundSellClick,
        updateFundSellCalc,
        handleFundSellConfirm,
        handleAirbnbSort,
        handleDeleteBrokerClick,
        handleConfirmDeleteBroker,
        handleRenameAsset,
        fetchREBrokers,
