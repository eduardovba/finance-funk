                            ...
                            renderItem={(tx: any) => (
                                <>
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <span className="font-medium text-[10px] text-white/90 uppercase tracking-wider font-space">{tx.quantity >= 0 ? 'Bought' : 'Sold'}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-sm font-bold text-white tracking-tight font-mono">{formatCurrency(Math.abs(tx.investment), 'BRL')}</span>
