                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-data-xs text-white/40 mt-0.5 font-space ">
                                                {prop.currency} · <span className={`px-1.5 py-0.5 rounded text-2xs uppercase font-bold ${prop.status === 'Sold' ? 'bg-yellow-500/20 text-yellow-500' : 'bg-emerald-500/20 text-emerald-400'}`}>{prop.status}</span>
                                        ...
                                        <div className="text-right shrink-0">
                                            ...
                                            <p className={`text-xs mt-0.5 font-semibold ${d.profitLoss >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-xs text-white/40 mt-0.5"><span className="px-1.5 py-0.5 rounded text-2xs uppercase font-bold bg-yellow-500/20 text-yellow-500">Sold</span></p>
                                                </div>
                                                <div className="text-right shrink-0">
                                                    <span className={`text-sm font-bold ${d.profitLoss >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                                                        {d.profitLoss >= 0 ? '+' : ''}{formatCurrency(d.profitLoss, prop.currency)}
