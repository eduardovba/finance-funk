...
export default function AllocationChart({ actual, targets }: { actual: any; targets: any; }) {
    // Transform data for Recharts
    // buckets: ['Equity', 'FixedIncome', 'RealEstate', 'Crypto']
    // actual: { Equity: 1000, ... } (Amounts)
    // targets: { Equity: 50, ... } (Percentages)

    const totalActual = Object.values(actual.buckets).reduce((a: any, b: any) => a + b, 0) as number;
